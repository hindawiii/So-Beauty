    ...
    <section id="product-reviews" className="pt-10 pb-4 border-t border-slate-200/80">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold mb-2">
            ...
            <span>آراء وتجارب العميلات</span>
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">
            تقييمات مجربة لـ {productName}
          </h2>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            آراء حقيقية من عميلاتنا اللاتي جربن هذا المنتج في روتينهن اليومي
          </p>
        </div>
        ...
        <AddReviewDialog
          ...
          triggerButton={
            <Button className="h-11 px-5 rounded-xl font-semibold gap-2 shadow-xs shrink-0">
              <MessageSquareHeart className="w-4 h-4" />
              <span>أضيفي تقييمكِ الآن</span>
            </Button>
          }
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-4 text-center md:border-e md:border-slate-200/80 md:pe-6">
            ...
            <p className="text-xs text-slate-500 font-medium">
              بناءً على <strong className="text-slate-800">{totalCount}</strong> تقييم ومراجعة
            </p>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          >
            الترتيب: {sortBy === "newest" ? "الأحدث أولاً" : "الأعلى تقييماً"}
          </button>
        </div>
      </div>
      ...
      {loading ? (
        <div className="py-12 text-center">
          ...
          <p className="text-xs text-slate-400">جاري تحميل آراء العميلات...</p>
        </div>
        ...
        <div className="bg-muted/30 border border-slate-200/80 rounded-3xl p-8 text-center max-w-md mx-auto my-6">
          ...
          <p className="text-xs text-slate-500 mb-4">
            كوني أول من يشارك تجربته مع {productName} لتحصلي على شارة عميلة مميزة!
          </p>
          <Button
            variant="outline"
            onClick={() => setFilterRating(null)}
          ...
          {displayedReviews.map((rev) => (
            ...
            >
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        {rev.is_verified && (
                          <span
                            ...
                            title="شراء مؤكد من متجر سو بيوتي"
                          >
                            <CheckCircle2 className="w-3 h-3 text-emerald-600" />
                            <span>مشترية مؤكدة</span>
                          </span>
                        )}
                      </div>
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
                <span className="text-[11px]">تجربة موثوقة لـ {productName}</span>
                <button
                  type="button"
